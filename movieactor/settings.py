"""
Django settings for movieactor project.
...
if DJANGO_HOST == "production":
    DEBUG = False
    STATIC_URL = 'https://movie-actor.herokuapp.com/ '
else:
    DEBUG = True
    STATIC_URL = '/static/'
...
WSGI_APPLICATION = 'movieactor.wsgi.application'
